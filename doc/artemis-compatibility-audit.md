...
- 兼容引擎：[artemis-compat](https://github.com/Weiss-UltimateSavior/artemis-compat)，本项目 vendor 源码以 `2c44929ca854ec5dbab6f0727fb21179c62b4b4a` 为同步基线，并单独回移 `2dcab320924738cab091ee027336559712a0944b` 的 PF8 读取优化；宿主差异与附加修补见 `cpp/artemis/upstream/UPSTREAM.md`。
